...
BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = @ClientTableName AND type = 'U')
    BEGIN
        CREATE TABLE Client (
   ...
   IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = @ProduitTableName AND type = 'U')
    BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = @ClientLogTableName AND type = 'U')
BEGIN
...
END
    ...
    IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = @ProduitLogTableName AND type = 'U')
    BEGIN
